...
const DealerName = styled.span<{ theme: ThemeType; one?: boolean; all?: boolean }>`
  ...
  color: #4d4d4d;
  font-size: ${(props) =>
    props.one ? props.theme.font.size.dealers.one.title.xs : props.theme.font.size.dealers.default.title.xs};
  line-height: ${(props) =>
    props.one
  ...
  @media screen and ( min-width: 768px ) {
    font-weight: bold;
    font-size: ${(props) =>
      props.all ? props.theme.font.size.dealers.main.title.md : props.theme.font.size.dealers.default.title.md};
    line-height: ${(props) =>
      props.all
        ? props.theme.font.lineHeight.dealers.main.title.md
        : props.theme.font.lineHeight.dealers.default.title.md};
  }
`;

const DealerAllSubtitle = styled.span<{ theme: ThemeType; one?: boolean; all?: boolean }>`
  margin-top: -1px;
  display: block;
  color: #6b6b6b;
  font-size: ${(props) =>
    props.one ? props.theme.font.size.dealers.one.subtitle.xs : props.theme.font.size.dealers.default.subtitle.xs};
  line-height: ${(props) =>
    props.one
      ? props.theme.font.lineHeight.dealers.one.subtitle.xs
      : props.theme.font.lineHeight.dealers.default.subtitle.xs};
